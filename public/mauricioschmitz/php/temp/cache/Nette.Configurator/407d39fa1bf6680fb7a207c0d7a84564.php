...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz',
			'wwwDir' => '/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz',
			'debugMode' => TRUE,
			...
			'tempDir' => '/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz/php/temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz/php/temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz/php/temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/users/mauricioschmitz/Sites/zf2-tutorial/public/mauricioschmitz/php/temp/cache', $this->getService('nette.cacheJournal'));
